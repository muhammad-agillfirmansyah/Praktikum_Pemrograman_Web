...
// Mendapatkan nama pengguna dari sesi untuk ucapan selamat datang
$nama_pengguna = isset($_SESSION['registered_name']) ? $_SESSION['registered_name'] : "Pengguna";
?>
...
<body>
    ...
    <section class="welcome-section" style="text-align: center; padding: 20px; background-color: #f4f4f4;">
        <h1 style="font-size: 2.5em; color: #333;">Selamat Datang, <span style="color: #4CAF50;"><?php echo $nama_pengguna; ?></span>!</h1>
        <p style="font-size: 1.2em; color: #666;">Kami sangat senang menyambut Anda di Toko HP. Temukan produk terbaik kami di bawah ini!</p>
    </section>
